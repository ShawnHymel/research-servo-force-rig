...
# Test settings
DATA_PATH = "data/p1s/45_deg/0mm/6_0V"
...
COOLDOWN_POSITION = 0.5     # Position to move to between tests
...
POSITIONS = [[0.0, 1.0], [1.0, 0.0], [0.0, 0.333], [0.333, 0.0], [0.333, 1.0], [1.0, 0.333]] # All positions
# POSITIONS = [[0.0, 1.0], [0.0, 0.333], [0.333, 0.0], [0.333, 1.0]] # Hook facing down
# POSITIONS = [[1.0, 0.5], [1.0, 0.0]] # Hook facing up
# POSITIONS = [[0.0, 0.5], [0.5, 0.0]]  # Redo positions
